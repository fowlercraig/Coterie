...
<div id="index">
	...
	<div class="fs-row fs-row-full">
	<div class="home-module fs-cell fs-lg-half fs-md-half fs-sm-3"><div class="wallpaper banner banner-medium" data-background-options='{"source":"/assets/15_09_23_m6.jpg"}'></div></div>
	<div class="home-module fs-cell fs-lg-half fs-md-half fs-sm-3"><div class="wallpaper banner banner-medium" data-background-options='{"source":"/assets/15_09_23_m6.jpg"}'></div></div>
	<div class="home-module fs-cell fs-lg-full fs-md-full fs-sm-3"><div class="wallpaper banner banner-medium" data-background-options='{"source":"/assets/15_09_23_m6.jpg"}'></div></div>
	</div>
</div>